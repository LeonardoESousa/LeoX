...
REQUIRED = ['numpy', 'scipy', 'pandas','wheel', 'requests', 'joblib']
...
setup(
    ...
    entry_points={'console_scripts': ["lx = lx.__main__:main", "lx_batch_run = lx.batch:run_batch", "lx_omega = lx.omega:main", "lx_conf_search = lx.conf_search:main"]},
